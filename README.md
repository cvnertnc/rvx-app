...
<ul>
 <li> Supports all present and future ReVanced and <a href="https://github.com/anddea/revanced-patches">ReVanced Extended</a> apps (including projects implementing the same interface like Morphe)</li>
